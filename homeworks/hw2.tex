...
\begin{itemize}
    ...
    Recall that the best rank-$k$ approximation of $M$ in Frobenius norm is attained by $B = \Sigma_{i=1}^k\sigma_i u_i v_i^T.$ Show that $$||M-B||_{F}=\sqrt{\sum_{i=k+1}^r\sigma_i^2}.$$
