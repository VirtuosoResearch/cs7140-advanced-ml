...
\begin{itemize}
    ...
    [Hint: Use the fact that $\sum_{i=1}^k \lambda_i(X)$ (the $i$-th largest singular value of $X$) is convex for any matrix $X$ and any $k$ less than or equal to the rank of $X$.]
\end{itemize}
